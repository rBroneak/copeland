...
class Texas extends Walker {
    ...
    public function start_el( &$output, $category, $depth = 0, $args = array(), $id = 0 ) {
        ...
        if ( 'list' == $args['style'] ) {
            $output .= "\t<li data-query='$category->term_id'";
...
<section class="row">
    ...
    <script type="text/javascript">
        ...
        (function($) {
            $('.categories > ul > li').addClass('base-href');
            $('ul.children li a').each(function(){
                var query = '?cat='+($(this).parent().attr('data-query'));
                var base = $(this).closest('.base-href').first().children('a').attr('href');
                $(this).attr('href','');
