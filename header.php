	...
	<script>(function(d, s, id) {
	  ...
	  fjs.parentNode.insertBefore(js, fjs);
		...
		<section class="container hfeed">
			<header id="masthead" role="banner" class="wrap">
			<?php do_action( 'before' ); ?>

				<section class="row global-header">
				<?php if ( function_exists( 'jetpack_the_site_logo' ) ) jetpack_the_site_logo(); ?>
                    <div class="toms-image">
                        <img src="<?php echo get_template_directory_uri(); ?>/images/tom-copeland-header.png">
                    </div>
					<hgroup id="branding" >
